...
<html>
    ...
    <body>
        ...
        <div id="bloc_page">
        	<header>
        		<div id="logo">
        	    <img src="user/${id }.jpg" title="Photo de profil" >
        	    <h1>${nom }</h1>
                ...
                <nav>
                	<ul>
                		...
                		<li><a href="Accueil" ><span class="acceuil">Accueil</span></a></li>
                		<li><a href="Accueil" ><span class="acceuil">Courier</span></a></li>
            ...
            <nav>
                  <form method="post" action="Image" class="form1">
                      ...
                      <label for="budget" class="element" ><br/> Budget <br /></label>
                        ...
                        <div class="type">
                           <input type="radio" id="type1" name="type" value="vente" <c:if test="${sessionScope.mode=='vente' }">checked</c:if>><label for="type1">Vente</label>
                           <input type="radio" id="type2" name="type" value="location"<c:if test="${sessionScope.mode=='location' }">checked</c:if>><label for="type2">Location</label>
                        </div>
                        </c:if>
                        <c:if test="${!empty nombre1 }">
                        <div class="type">
                         <input type="radio" id="type1" name="type" value="vente" <c:if test="${nombre1==1 }">checked</c:if>><label for="type1">Vente</label>
                           <input type="radio" id="type2" name="type" value="location"<c:if test="${nombre1==2 }">checked</c:if>><label for="type2">Location</label>
                           </div>
                           </c:if>
       ...
       <c:forEach var="list" items="${ sessionScope.tous }">
            <div class="annonce">
         		...
         		<c:if test="${list[7]=='location' }">
         			<h3> <span class="gmara">${list[14]}DT/mois</span></h3>
         		</c:if>
         		<c:if test="${list[7]=='vente' }">
