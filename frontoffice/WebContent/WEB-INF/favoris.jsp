...
<html>
    ...
    <body>
       ...
       <c:forEach var="list" items="${favoris }">
            <div class="annonce">
         		...
         		<a href="Listefavoris?verif=${list[0] }"><img src="coeur-r.png" title="enlever de favoris"></a> 
         		<h1> ${list[4]}</h1>
         		...
         		<div class="position">
         		<form method="get" action="Test3" class="clique" >
        ...
        <c:if test="${! empty ch }">
        <h1> Vous n'avez aucun bien en favoris </h1>
        </c:if>
            </section>
            </div>
            </body>
